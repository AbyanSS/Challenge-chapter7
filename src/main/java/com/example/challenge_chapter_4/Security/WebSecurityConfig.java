...
import com.example.challenge_chapter_4.Filter.JwtAuthFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity.csrf()
                ...
                .requestMatchers("/Film","/Jadwal","/Seats","/Studio",
                        "/Film/Judul-Film/{film_name}","/Film/Tayang","/Film/Jadwal/{film_name}","/Seats/Studios/{studio}/{nomor_kursi}","/swagger-ui/**","/v3/api-docs/**","/Auth/**","/Transaction/**","/Msg/**","/Notifications/**").permitAll()
//                .anyRequest().authenticated().and().httpBasic() formLogin()
                .and().authorizeHttpRequests().requestMatchers("/Users/**","/Film/**","/Jadwal/**","/Report/**").authenticated().and().sessionManagement()
